...
addFilter(
	...
	'ctx-blocks/post-featured-image',
	addFeaturedImageAttribute
);

const withFeaturedImageControl = createHigherOrderComponent(
	(BlockEdit: (props: BlockEditProps<FeaturedImageAttributes>) => JSX.Element) => {
		return (props: BlockEditProps<FeaturedImageAttributes>) => {
